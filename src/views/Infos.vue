...
let rules = reactive({
  ...
  Hospital: [
    { required: true, message: i18n.global.t('info_page.inputHospitalId'), trigger: 'change' }
  ],
  patient: [
    { required: true, message: i18n.global.t('info_page.inputPatientId'), trigger: 'change' }
  ],
  number: [
      ...
      <el-main class="blur-box">
        ...
        <div style="display: flex">
          ...
          >
            ...
            <el-form-item :label="$t('info_page.Hospital_id')" prop="Hospital">
              <el-input
                v-model="ruleForm.Hospital"
                :placeholder="$t('info_page.Hospital_text')"
              ></el-input>
            </el-form-item>
